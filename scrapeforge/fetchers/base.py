...
class BaseFetcher(ABC):
    ...
    async def fetch(self, url: str, options: FetchOptions) -> FetchResponse:
        ...
        Returns:
            A :class:`~scrapeforge.models.FetchResponse`.

        Raises:
            FetchError: On any transport-level failure. Subclasses translate
                library-specific exceptions into the scrapeforge hierarchy.
        """
    ...
    def build_response(
        ...
        *,
        ...
        """Assemble a :class:`~scrapeforge.models.FetchResponse` from raw parts."""
