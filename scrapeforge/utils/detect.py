...
:class:`~scrapeforge.exceptions.ChallengeError`.
"""
...
def detect_content_type(header_value: str | None, body: bytes | None = None) -> ContentType:
    ...
    Returns:
        The resolved :class:`~scrapeforge.models.ContentType`.
    """
...
def sniff_body(body: bytes | None) -> ContentType:
    ...
    Returns :attr:`~scrapeforge.models.ContentType.UNKNOWN` when nothing matches.
    """
    if not body:
