"""A guided walkthrough of scrapekit against real, public example sites.
...
from scrapekit import ChallengeError, ContentType, Scraper
...
class TestJsonApis:
    ...
    async def test_post_json_body(self, scraper):
        ...
        assert seen["x-scrapekit-example"] == "1"
...
class TestBeingBlocked:
    async def test_a_block_raises_challenge_error_rather_than_returning_junk(self, scraper):
        ...
        ``ChallengeError`` describing what matched. scrapekit deliberately stops
